 ...
 */
@JsonPropertyOrder({
  EventDto.JSON_PROPERTY_ENTITY_ID,
  EventDto.JSON_PROPERTY_NAME,
  EventDto.JSON_PROPERTY_SEQUENCE_NUMBER
})
...
public class EventDto {
  ...
  public EventDto entityId(String entityId) {
  ...
  **/
  ...
  public EventDto sequenceNumber(Integer sequenceNumber) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Event sequence number")
  ...
  /**
   * Return true if this EventDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entityId, eventDto.entityId) &&
        Objects.equals(this.name, eventDto.name) &&
        Objects.equals(this.sequenceNumber, eventDto.sequenceNumber);
  }
