 ...
 */
@ApiModel(description = "The user session query result as a tree.")
@JsonPropertyOrder({
  DtaqlResultAsTree.JSON_PROPERTY_EXTRAPOLATION_LEVEL,
  DtaqlResultAsTree.JSON_PROPERTY_ADDITIONAL_COLUMN_NAMES,
  DtaqlResultAsTree.JSON_PROPERTY_ADDITIONAL_VALUES,
  DtaqlResultAsTree.JSON_PROPERTY_EXPLANATIONS,
  DtaqlResultAsTree.JSON_PROPERTY_BRANCH_NAMES,
  DtaqlResultAsTree.JSON_PROPERTY_LEAF_NAMES,
  DtaqlResultAsTree.JSON_PROPERTY_VALUES
})
...
public class DtaqlResultAsTree {
  ...
  public static final String JSON_PROPERTY_LEAF_NAMES = "leafNames";
  private List<String> leafNames = null;

  public static final String JSON_PROPERTY_VALUES = "values";
  private Object values;

  public DtaqlResultAsTree() { 
  }

  public DtaqlResultAsTree extrapolationLevel(Integer extrapolationLevel) {
  ...
  **/
  ...
  public DtaqlResultAsTree additionalColumnNames(List<String> additionalColumnNames) {
    this.additionalColumnNames = additionalColumnNames;
    return this;
  }

  public DtaqlResultAsTree addAdditionalColumnNamesItem(String additionalColumnNamesItem) {
  ...
  **/
  ...
  public DtaqlResultAsTree additionalValues(List<List<Object>> additionalValues) {
    this.additionalValues = additionalValues;
    return this;
  }

  public DtaqlResultAsTree addAdditionalValuesItem(List<Object> additionalValuesItem) {
  ...
  **/
  ...
  public DtaqlResultAsTree explanations(List<String> explanations) {
    this.explanations = explanations;
    return this;
  }

  public DtaqlResultAsTree addExplanationsItem(String explanationsItem) {
  ...
  **/
  ...
  public DtaqlResultAsTree branchNames(List<String> branchNames) {
    this.branchNames = branchNames;
    return this;
  }

  public DtaqlResultAsTree addBranchNamesItem(String branchNamesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of branches of the tree.    Typically, these are fields from the `SELECT` clause, that have been used in the `GROUP BY` clause.")
  ...
  public DtaqlResultAsTree leafNames(List<String> leafNames) {
    this.leafNames = leafNames;
    return this;
  }

  public DtaqlResultAsTree addLeafNamesItem(String leafNamesItem) {
    if (this.leafNames == null) {
      this.leafNames = new ArrayList<>();
    }
    this.leafNames.add(leafNamesItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of leaves on each tree branch.    Typically, these are fields from the `SELECT` clause, that have not been used in the `GROUP BY` clause.")
  @JsonProperty(JSON_PROPERTY_LEAF_NAMES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public DtaqlResultAsTree values(Object values) {
    this.values = values;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user session query result as a tree.")
  ...
  /**
   * Return true if this DtaqlResultAsTree object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DtaqlResultAsTree dtaqlResultAsTree = (DtaqlResultAsTree) o;
    return Objects.equals(this.extrapolationLevel, dtaqlResultAsTree.extrapolationLevel) &&
        Objects.equals(this.additionalColumnNames, dtaqlResultAsTree.additionalColumnNames) &&
        Objects.equals(this.additionalValues, dtaqlResultAsTree.additionalValues) &&
        Objects.equals(this.explanations, dtaqlResultAsTree.explanations) &&
        Objects.equals(this.branchNames, dtaqlResultAsTree.branchNames) &&
        Objects.equals(this.leafNames, dtaqlResultAsTree.leafNames) &&
        Objects.equals(this.values, dtaqlResultAsTree.values);
  }

  @Override
  public int hashCode() {
    return Objects.hash(extrapolationLevel, additionalColumnNames, additionalValues, explanations, branchNames, leafNames, values);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DtaqlResultAsTree {\n");
    ...
    sb.append("    leafNames: ").append(toIndentedString(leafNames)).append("\n");
