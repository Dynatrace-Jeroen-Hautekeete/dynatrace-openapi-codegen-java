 ...
 */
@ApiModel(description = "Set of parameters of the event.    Apart from the general properties mentioned here, which each event has, an actual event has a set of metadata that varies depending on the event type.")
@JsonPropertyOrder({
  EventRestEntry.JSON_PROPERTY_START_TIME,
  EventRestEntry.JSON_PROPERTY_END_TIME,
  EventRestEntry.JSON_PROPERTY_ENTITY_ID,
  EventRestEntry.JSON_PROPERTY_ENTITY_NAME,
  EventRestEntry.JSON_PROPERTY_SEVERITY_LEVEL,
  EventRestEntry.JSON_PROPERTY_IMPACT_LEVEL,
  EventRestEntry.JSON_PROPERTY_EVENT_TYPE,
  EventRestEntry.JSON_PROPERTY_RESOURCE_ID,
  EventRestEntry.JSON_PROPERTY_RESOURCE_NAME,
  EventRestEntry.JSON_PROPERTY_EVENT_STATUS,
  EventRestEntry.JSON_PROPERTY_TAGS,
  EventRestEntry.JSON_PROPERTY_ID
})
...
public class EventRestEntry {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The timestamp of the event closure, in UTC milliseconds")
  ...
  **/
  ...
  public EventRestEntry resourceId(String resourceId) {
  ...
  **/
  ...
  public EventRestEntry resourceName(String resourceName) {
  ...
  **/
  ...
  public EventRestEntry eventStatus(EventStatusEnum eventStatus) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of the event: open or closed.")
  ...
  public EventRestEntry tags(Set<TagInfo> tags) {
    this.tags = tags;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Tags of the Dynatrace entity that raised the event.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The encoded ID of the event. The format is *eventID_startTime*.    You should use the value from this field when you need an event ID. ")
  ...
  /**
   * Return true if this EventRestEntry object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EventRestEntry eventRestEntry = (EventRestEntry) o;
    return Objects.equals(this.startTime, eventRestEntry.startTime) &&
        Objects.equals(this.endTime, eventRestEntry.endTime) &&
        Objects.equals(this.entityId, eventRestEntry.entityId) &&
        Objects.equals(this.entityName, eventRestEntry.entityName) &&
        Objects.equals(this.severityLevel, eventRestEntry.severityLevel) &&
        Objects.equals(this.impactLevel, eventRestEntry.impactLevel) &&
        Objects.equals(this.eventType, eventRestEntry.eventType) &&
        Objects.equals(this.resourceId, eventRestEntry.resourceId) &&
        Objects.equals(this.resourceName, eventRestEntry.resourceName) &&
        Objects.equals(this.eventStatus, eventRestEntry.eventStatus) &&
        Objects.equals(this.tags, eventRestEntry.tags) &&
        Objects.equals(this.id, eventRestEntry.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startTime, endTime, entityId, entityName, severityLevel, impactLevel, eventType, resourceId, resourceName, eventStatus, tags, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventRestEntry {\n");
