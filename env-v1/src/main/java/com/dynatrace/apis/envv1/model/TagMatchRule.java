 ...
 */
@ApiModel(description = "The list of tags to be used for matching Dynatrace entities.")
@JsonPropertyOrder({
  TagMatchRule.JSON_PROPERTY_ME_TYPES,
  TagMatchRule.JSON_PROPERTY_TAGS
})
...
public class TagMatchRule {
  ...
  public enum MeTypesEnum {
    ...
    @JsonCreator
    public static MeTypesEnum fromValue(String value) {
      for (MeTypesEnum b : MeTypesEnum.values()) {
  ...
  public static final String JSON_PROPERTY_ME_TYPES = "meTypes";
  private List<MeTypesEnum> meTypes = new ArrayList<>();
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The list of types of the Dynatrace entities (for example hosts or services) you want to pick up by matching.")
  @JsonProperty(JSON_PROPERTY_ME_TYPES)
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The list of tags you want to use for matching. At least one tag is required.    You can use custom tags from the UI, imported tags, and tags based on environment variables.")
  ...
  /**
   * Return true if this TagMatchRule object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TagMatchRule tagMatchRule = (TagMatchRule) o;
    return Objects.equals(this.meTypes, tagMatchRule.meTypes) &&
        Objects.equals(this.tags, tagMatchRule.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meTypes, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TagMatchRule {\n");
    sb.append("    meTypes: ").append(toIndentedString(meTypes)).append("\n");
