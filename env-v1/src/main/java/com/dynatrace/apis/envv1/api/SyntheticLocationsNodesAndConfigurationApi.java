...
public class SyntheticLocationsNodesAndConfigurationApi {
   ...
   */
  public EntityIdDto addLocation(PrivateSyntheticLocation privateSyntheticLocation) throws ApiException {
    ApiResponse<EntityIdDto> localVarResponse = addLocationWithHttpInfo(privateSyntheticLocation);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<EntityIdDto> addLocationWithHttpInfo(PrivateSyntheticLocation privateSyntheticLocation) throws ApiException {
   ...
   * @param type Filters the resulting set of locations by a specific type. (optional)
   ...
   * @param syntheticLocationUpdate The JSON body of the request. Contains updated parameters of the private synthetic location or the status of the location. (optional)
   * @throws ApiException if fails to make API call
   */
   ...
   * 
   * @param syntheticPublicLocationsStatus The updated synthetic locations status (optional)
   * @throws ApiException if fails to make API call
   */
