 ...
 */
@JsonPropertyOrder({
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_NODES,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_NAME,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_COUNTRY_CODE,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_REGION_CODE,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_CITY,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_LATITUDE,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_LONGITUDE,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_STATUS,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_AVAILABILITY_LOCATION_OUTAGE,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_AVAILABILITY_NODE_OUTAGE,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_LOCATION_NODE_OUTAGE_DELAY_IN_MINUTES,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_AVAILABILITY_NOTIFICATIONS_ENABLED,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_AUTO_UPDATE_CHROMIUM,
  PrivateSyntheticLocationUpdateAllOf.JSON_PROPERTY_DEPLOYMENT_TYPE
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-02T15:08:03.911513100+01:00[Europe/Brussels]")
public class PrivateSyntheticLocationUpdateAllOf {
  ...
  public PrivateSyntheticLocationUpdateAllOf() { 
  }

  public PrivateSyntheticLocationUpdateAllOf nodes(List<String> nodes) {
    this.nodes = nodes;
    return this;
  }

  public PrivateSyntheticLocationUpdateAllOf addNodesItem(String nodesItem) {
    if (this.nodes == null) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf countryCode(String countryCode) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf regionCode(String regionCode) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf latitude(Double latitude) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf longitude(Double longitude) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf availabilityLocationOutage(Boolean availabilityLocationOutage) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf availabilityNodeOutage(Boolean availabilityNodeOutage) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf locationNodeOutageDelayInMinutes(Integer locationNodeOutageDelayInMinutes) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf availabilityNotificationsEnabled(Boolean availabilityNotificationsEnabled) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf autoUpdateChromium(Boolean autoUpdateChromium) {
  ...
  **/
  ...
  public PrivateSyntheticLocationUpdateAllOf deploymentType(DeploymentTypeEnum deploymentType) {
  ...
  **/
  ...
  /**
   * Return true if this PrivateSyntheticLocationUpdate_allOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PrivateSyntheticLocationUpdateAllOf privateSyntheticLocationUpdateAllOf = (PrivateSyntheticLocationUpdateAllOf) o;
    return Objects.equals(this.nodes, privateSyntheticLocationUpdateAllOf.nodes) &&
        Objects.equals(this.name, privateSyntheticLocationUpdateAllOf.name) &&
        Objects.equals(this.countryCode, privateSyntheticLocationUpdateAllOf.countryCode) &&
        Objects.equals(this.regionCode, privateSyntheticLocationUpdateAllOf.regionCode) &&
        Objects.equals(this.city, privateSyntheticLocationUpdateAllOf.city) &&
        Objects.equals(this.latitude, privateSyntheticLocationUpdateAllOf.latitude) &&
        Objects.equals(this.longitude, privateSyntheticLocationUpdateAllOf.longitude) &&
        Objects.equals(this.status, privateSyntheticLocationUpdateAllOf.status) &&
        Objects.equals(this.availabilityLocationOutage, privateSyntheticLocationUpdateAllOf.availabilityLocationOutage) &&
        Objects.equals(this.availabilityNodeOutage, privateSyntheticLocationUpdateAllOf.availabilityNodeOutage) &&
        Objects.equals(this.locationNodeOutageDelayInMinutes, privateSyntheticLocationUpdateAllOf.locationNodeOutageDelayInMinutes) &&
        Objects.equals(this.availabilityNotificationsEnabled, privateSyntheticLocationUpdateAllOf.availabilityNotificationsEnabled) &&
        Objects.equals(this.autoUpdateChromium, privateSyntheticLocationUpdateAllOf.autoUpdateChromium) &&
        Objects.equals(this.deploymentType, privateSyntheticLocationUpdateAllOf.deploymentType);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrivateSyntheticLocationUpdateAllOf {\n");
