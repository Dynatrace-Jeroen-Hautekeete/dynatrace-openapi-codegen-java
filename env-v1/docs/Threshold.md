...
|**timeseriesId** | **String** | The case-sensitive ID of the metric evaluated by threshold.   You can use it to find the metric via the &#x60;timeseries&#x60; endpoint of the API. |  [optional] |
...
|**samples** | **Integer** | The number of one-minute samples that form sliding evaluation window. |  [optional] |
...
|**eventName** | **String** | The name of the event to trigger on the threshold violation. |  [optional] |
|**filter** | [**FilterEnum**](#FilterEnum) | The source of the threshold. |  [optional] |
