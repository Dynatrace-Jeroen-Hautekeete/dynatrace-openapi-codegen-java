...
| [**getVersionWithHttpInfo**](ClusterVersionApi.md#getVersionWithHttpInfo) | **GET** /config/clusterversion | Gets the current version of the Dynatrace server |
...
import com.dynatrace.apis.envv1.api.ClusterVersionApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ClusterVersion result = apiInstance.getVersion();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ClusterVersionApi#getVersion");
...
> ApiResponse<ClusterVersion> getVersion getVersionWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        ClusterVersionApi apiInstance = new ClusterVersionApi(defaultClient);
        try {
            ApiResponse<ClusterVersion> response = apiInstance.getVersionWithHttpInfo();
...
ApiResponse<[**ClusterVersion**](ClusterVersion.md)>
