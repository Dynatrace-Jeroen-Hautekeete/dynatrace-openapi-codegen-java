...
| [**deleteTagsWithHttpInfo**](MonitoredEntitiesCustomTagsApi.md#deleteTagsWithHttpInfo) | **DELETE** /tags | Deletes the specified tag from the specified entities |
| [**getTags**](MonitoredEntitiesCustomTagsApi.md#getTags) | **GET** /tags | Gets a list of custom tags applied to the specified entities |
| [**getTagsWithHttpInfo**](MonitoredEntitiesCustomTagsApi.md#getTagsWithHttpInfo) | **GET** /tags | Gets a list of custom tags applied to the specified entities |
| [**postTags**](MonitoredEntitiesCustomTagsApi.md#postTags) | **POST** /tags | Adds custom tags to the specified entities |
| [**postTagsWithHttpInfo**](MonitoredEntitiesCustomTagsApi.md#postTagsWithHttpInfo) | **POST** /tags | Adds custom tags to the specified entities |



## deleteTags

> DeletedEntityTags deleteTags(key, entitySelector, value, deleteAllWithKey, from, to)
...
import com.dynatrace.apis.envv2.api.MonitoredEntitiesCustomTagsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            DeletedEntityTags result = apiInstance.deleteTags(key, entitySelector, value, deleteAllWithKey, from, to);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MonitoredEntitiesCustomTagsApi#deleteTags");
...
| **value** | **String**| The value of the tag to be deleted. The value is ignored if **deleteAllWithKey** is &#x60;true&#x60;.   For value-only tags, specify the value in the **key** parameter. | [optional] |
| **deleteAllWithKey** | **Boolean**| * If &#x60;true&#x60;, all tags with the specified key are deleted, regardless of the value.  * If &#x60;false&#x60;, only tags with exact match of key **and** value are deleted.   If not set, &#x60;false&#x60; is used. | [optional] |
...
> ApiResponse<DeletedEntityTags> deleteTags deleteTagsWithHttpInfo(key, entitySelector, value, deleteAllWithKey, from, to)
...
public class Example {
    public static void main(String[] args) {
        ...
        String to = "to_example"; // String | The end of the requested timeframe.   You can use one of the following formats:  * Timestamp in UTC milliseconds.  * Human-readable format of `2021-01-25T05:57:01.123+01:00`. If no time zone is specified, UTC is used. You can use a space character instead of the `T`. Seconds and fractions of a second are optional.  * Relative timeframe, back from now. The format is `now-NU/A`, where `N` is the amount of time, `U` is the unit of time, and `A` is an alignment. The alignment rounds all the smaller values to the nearest zero in the past. For example, `now-1y/w` is one year back, aligned by a week.  You can also specify relative timeframe without an alignment: `now-NU`.  Supported time units for the relative timeframe are:     * `m`: minutes     * `h`: hours     * `d`: days     * `w`: weeks     * `M`: months     * `y`: years   If not set, the current timestamp is used.
        try {
            ApiResponse<DeletedEntityTags> response = apiInstance.deleteTagsWithHttpInfo(key, entitySelector, value, deleteAllWithKey, from, to);
...
ApiResponse<[**DeletedEntityTags**](DeletedEntityTags.md)>
...
> CustomEntityTags getTags(entitySelector, from, to)
...
public class Example {
    public static void main(String[] args) {
        ...
        String to = "to_example"; // String | The end of the requested timeframe.   You can use one of the following formats:  * Timestamp in UTC milliseconds.  * Human-readable format of `2021-01-25T05:57:01.123+01:00`. If no time zone is specified, UTC is used. You can use a space character instead of the `T`. Seconds and fractions of a second are optional.  * Relative timeframe, back from now. The format is `now-NU/A`, where `N` is the amount of time, `U` is the unit of time, and `A` is an alignment. The alignment rounds all the smaller values to the nearest zero in the past. For example, `now-1y/w` is one year back, aligned by a week.  You can also specify relative timeframe without an alignment: `now-NU`.  Supported time units for the relative timeframe are:     * `m`: minutes     * `h`: hours     * `d`: days     * `w`: weeks     * `M`: months     * `y`: years   If not set, the current timestamp is used.
        try {
            CustomEntityTags result = apiInstance.getTags(entitySelector, from, to);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MonitoredEntitiesCustomTagsApi#getTags");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ApiResponse<CustomEntityTags> getTags getTagsWithHttpInfo(entitySelector, from, to)
...
public class Example {
    public static void main(String[] args) {
        ...
        String to = "to_example"; // String | The end of the requested timeframe.   You can use one of the following formats:  * Timestamp in UTC milliseconds.  * Human-readable format of `2021-01-25T05:57:01.123+01:00`. If no time zone is specified, UTC is used. You can use a space character instead of the `T`. Seconds and fractions of a second are optional.  * Relative timeframe, back from now. The format is `now-NU/A`, where `N` is the amount of time, `U` is the unit of time, and `A` is an alignment. The alignment rounds all the smaller values to the nearest zero in the past. For example, `now-1y/w` is one year back, aligned by a week.  You can also specify relative timeframe without an alignment: `now-NU`.  Supported time units for the relative timeframe are:     * `m`: minutes     * `h`: hours     * `d`: days     * `w`: weeks     * `M`: months     * `y`: years   If not set, the current timestamp is used.
        try {
            ApiResponse<CustomEntityTags> response = apiInstance.getTagsWithHttpInfo(entitySelector, from, to);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**CustomEntityTags**](CustomEntityTags.md)>
...
> AddedEntityTags postTags(entitySelector, from, to, addEntityTags)
...
public class Example {
    public static void main(String[] args) {
        ...
        String from = "from_example"; // String | The start of the requested timeframe.   You can use one of the following formats:  * Timestamp in UTC milliseconds.  * Human-readable format of `2021-01-25T05:57:01.123+01:00`. If no time zone is specified, UTC is used. You can use a space character instead of the `T`. Seconds and fractions of a second are optional.  * Relative timeframe, back from now. The format is `now-NU/A`, where `N` is the amount of time, `U` is the unit of time, and `A` is an alignment. The alignment rounds all the smaller values to the nearest zero in the past. For example, `now-1y/w` is one year back, aligned by a week.  You can also specify relative timeframe without an alignment: `now-NU`.  Supported time units for the relative timeframe are:     * `m`: minutes     * `h`: hours     * `d`: days     * `w`: weeks     * `M`: months     * `y`: years   If not set, the relative timeframe of 24 hours is used (`now-24h`).
        String to = "to_example"; // String | The end of the requested timeframe.   You can use one of the following formats:  * Timestamp in UTC milliseconds.  * Human-readable format of `2021-01-25T05:57:01.123+01:00`. If no time zone is specified, UTC is used. You can use a space character instead of the `T`. Seconds and fractions of a second are optional.  * Relative timeframe, back from now. The format is `now-NU/A`, where `N` is the amount of time, `U` is the unit of time, and `A` is an alignment. The alignment rounds all the smaller values to the nearest zero in the past. For example, `now-1y/w` is one year back, aligned by a week.  You can also specify relative timeframe without an alignment: `now-NU`.  Supported time units for the relative timeframe are:     * `m`: minutes     * `h`: hours     * `d`: days     * `w`: weeks     * `M`: months     * `y`: years   If not set, the current timestamp is used.
        AddEntityTags addEntityTags = new AddEntityTags(); // AddEntityTags | The JSON body of the request. Contains tags to be added to the matching entities.
        try {
            AddedEntityTags result = apiInstance.postTags(entitySelector, from, to, addEntityTags);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MonitoredEntitiesCustomTagsApi#postTags");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| **from** | **String**| The start of the requested timeframe.   You can use one of the following formats:  * Timestamp in UTC milliseconds.  * Human-readable format of &#x60;2021-01-25T05:57:01.123+01:00&#x60;. If no time zone is specified, UTC is used. You can use a space character instead of the &#x60;T&#x60;. Seconds and fractions of a second are optional.  * Relative timeframe, back from now. The format is &#x60;now-NU/A&#x60;, where &#x60;N&#x60; is the amount of time, &#x60;U&#x60; is the unit of time, and &#x60;A&#x60; is an alignment. The alignment rounds all the smaller values to the nearest zero in the past. For example, &#x60;now-1y/w&#x60; is one year back, aligned by a week.  You can also specify relative timeframe without an alignment: &#x60;now-NU&#x60;.  Supported time units for the relative timeframe are:     * &#x60;m&#x60;: minutes     * &#x60;h&#x60;: hours     * &#x60;d&#x60;: days     * &#x60;w&#x60;: weeks     * &#x60;M&#x60;: months     * &#x60;y&#x60;: years   If not set, the relative timeframe of 24 hours is used (&#x60;now-24h&#x60;). | [optional] |
| **to** | **String**| The end of the requested timeframe.   You can use one of the following formats:  * Timestamp in UTC milliseconds.  * Human-readable format of &#x60;2021-01-25T05:57:01.123+01:00&#x60;. If no time zone is specified, UTC is used. You can use a space character instead of the &#x60;T&#x60;. Seconds and fractions of a second are optional.  * Relative timeframe, back from now. The format is &#x60;now-NU/A&#x60;, where &#x60;N&#x60; is the amount of time, &#x60;U&#x60; is the unit of time, and &#x60;A&#x60; is an alignment. The alignment rounds all the smaller values to the nearest zero in the past. For example, &#x60;now-1y/w&#x60; is one year back, aligned by a week.  You can also specify relative timeframe without an alignment: &#x60;now-NU&#x60;.  Supported time units for the relative timeframe are:     * &#x60;m&#x60;: minutes     * &#x60;h&#x60;: hours     * &#x60;d&#x60;: days     * &#x60;w&#x60;: weeks     * &#x60;M&#x60;: months     * &#x60;y&#x60;: years   If not set, the current timestamp is used. | [optional] |
| **addEntityTags** | [**AddEntityTags**](AddEntityTags.md)| The JSON body of the request. Contains tags to be added to the matching entities. | [optional] |
...
## postTagsWithHttpInfo

> ApiResponse<AddedEntityTags> postTags postTagsWithHttpInfo(entitySelector, from, to, addEntityTags)
...
public class Example {
    public static void main(String[] args) {
        ...
        AddEntityTags addEntityTags = new AddEntityTags(); // AddEntityTags | The JSON body of the request. Contains tags to be added to the matching entities.
        try {
            ApiResponse<AddedEntityTags> response = apiInstance.postTagsWithHttpInfo(entitySelector, from, to, addEntityTags);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**AddedEntityTags**](AddedEntityTags.md)>
