...
@JsonPropertyOrder({
  MetricDescriptorCollection.JSON_PROPERTY_NEXT_PAGE_KEY,
  MetricDescriptorCollection.JSON_PROPERTY_TOTAL_COUNT,
  MetricDescriptorCollection.JSON_PROPERTY_METRICS,
  MetricDescriptorCollection.JSON_PROPERTY_WARNINGS
})
...
public class MetricDescriptorCollection {
  ...
  public MetricDescriptorCollection() { 
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of metric along with their descriptors")
  ...
  **/
  ...
  /**
   * Return true if this MetricDescriptorCollection object is equal to o.
   */
  @Override
