 ...
 */
@ApiModel(description = "The availability evidence of the problem.   Indicates an entity that has been unavailable during the problem lifespan and that might be related to the root cause.")
@JsonPropertyOrder({
  AvailabilityEvidence.JSON_PROPERTY_END_TIME
})
...
public class AvailabilityEvidence extends Evidence {
  ...
  public AvailabilityEvidence endTime(Long endTime) {
  ...
  **/
  ...
  /**
   * Return true if this AvailabilityEvidence object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AvailabilityEvidence availabilityEvidence = (AvailabilityEvidence) o;
    return Objects.equals(this.endTime, availabilityEvidence.endTime) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endTime, super.hashCode());
  }
...
static {
  ...
  JSON.registerDiscriminator(AvailabilityEvidence.class, "evidenceType", mappings);
}
}
