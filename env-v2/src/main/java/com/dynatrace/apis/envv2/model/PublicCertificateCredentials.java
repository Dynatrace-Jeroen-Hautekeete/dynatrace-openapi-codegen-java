 ...
 */
@ApiModel(description = "A credentials set of the `PUBLIC_CERTIFICATE` type.")
@JsonPropertyOrder({
  PublicCertificateCredentials.JSON_PROPERTY_CERTIFICATE,
  PublicCertificateCredentials.JSON_PROPERTY_PASSWORD,
  PublicCertificateCredentials.JSON_PROPERTY_CERTIFICATE_FORMAT
})
...
public class PublicCertificateCredentials extends Credentials {
  ...
  public PublicCertificateCredentials() { 
  }

  public PublicCertificateCredentials certificate(String certificate) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The certificate in the string format.")
  ...
  public PublicCertificateCredentials password(String password) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The password of the credential (not supported).")
  ...
  public PublicCertificateCredentials certificateFormat(CertificateFormatEnum certificateFormat) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The certificate format.")
  ...
  /**
   * Return true if this PublicCertificateCredentials object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicCertificateCredentials publicCertificateCredentials = (PublicCertificateCredentials) o;
    return Objects.equals(this.certificate, publicCertificateCredentials.certificate) &&
        Objects.equals(this.password, publicCertificateCredentials.password) &&
        Objects.equals(this.certificateFormat, publicCertificateCredentials.certificateFormat) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificate, password, certificateFormat, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicCertificateCredentials {\n");
...
static {
  ...
  JSON.registerDiscriminator(PublicCertificateCredentials.class, "type", mappings);
}
}
