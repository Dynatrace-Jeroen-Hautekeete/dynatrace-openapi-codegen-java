 ...
 */
@ApiModel(description = "Analysis of problem impact to an application.")
@JsonPropertyOrder({
})
...
public class ApplicationImpact extends Impact {
  public ApplicationImpact() { 
  }

  /**
   * Return true if this ApplicationImpact object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(ApplicationImpact.class, "impactType", mappings);
}
}
