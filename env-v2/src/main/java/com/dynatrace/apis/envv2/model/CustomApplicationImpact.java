 ...
 */
@ApiModel(description = "Analysis of problem impact to a custom application.")
@JsonPropertyOrder({
})
...
public class CustomApplicationImpact extends Impact {
  public CustomApplicationImpact() { 
  }

  /**
   * Return true if this CustomApplicationImpact object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(CustomApplicationImpact.class, "impactType", mappings);
}
}
