 ...
 */
@ApiModel(description = "Comparison for `INTEGER` attributes.")
@JsonPropertyOrder({
  IntegerComparison.JSON_PROPERTY_OPERATOR,
  IntegerComparison.JSON_PROPERTY_VALUE
})
...
public class IntegerComparison extends ComparisonBasic {
  /**
  ...
  public IntegerComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public IntegerComparison value(Integer value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this IntegerComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IntegerComparison integerComparison = (IntegerComparison) o;
    return Objects.equals(this.operator, integerComparison.operator) &&
        Objects.equals(this.value, integerComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntegerComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(IntegerComparison.class, "type", mappings);
}
}
