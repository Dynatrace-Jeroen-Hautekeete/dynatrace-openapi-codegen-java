 ...
 */
@ApiModel(description = "Comparison for `HYPERVISOR_TYPE` attributes.")
@JsonPropertyOrder({
  HypervisorTypeComparision.JSON_PROPERTY_OPERATOR,
  HypervisorTypeComparision.JSON_PROPERTY_VALUE
})
...
public class HypervisorTypeComparision extends ComparisonBasic {
  /**
  ...
  public HypervisorTypeComparision() { 
  }

  public HypervisorTypeComparision operator(OperatorEnum operator) {
  ...
  **/
  ...
  public HypervisorTypeComparision value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this HypervisorTypeComparision object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    HypervisorTypeComparision hypervisorTypeComparision = (HypervisorTypeComparision) o;
    return Objects.equals(this.operator, hypervisorTypeComparision.operator) &&
        Objects.equals(this.value, hypervisorTypeComparision.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class HypervisorTypeComparision {\n");
...
static {
  ...
  JSON.registerDiscriminator(HypervisorTypeComparision.class, "type", mappings);
}
}
