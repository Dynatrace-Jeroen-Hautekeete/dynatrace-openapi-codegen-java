 ...
 */
@ApiModel(description = "Configuration of a tile with an assigned Dynatrace entity.   An example is the Bounce rate tile, showing the data from an assigned application.")
@JsonPropertyOrder({
  AssignedEntitiesTile.JSON_PROPERTY_ASSIGNED_ENTITIES
})
...
public class AssignedEntitiesTile extends Tile {
  ...
  public AssignedEntitiesTile() { 
  }

  public AssignedEntitiesTile assignedEntities(List<String> assignedEntities) {
    this.assignedEntities = assignedEntities;
    return this;
  }

  public AssignedEntitiesTile addAssignedEntitiesItem(String assignedEntitiesItem) {
  ...
  **/
  ...
  /**
   * Return true if this AssignedEntitiesTile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AssignedEntitiesTile assignedEntitiesTile = (AssignedEntitiesTile) o;
    return Objects.equals(this.assignedEntities, assignedEntitiesTile.assignedEntities) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assignedEntities, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssignedEntitiesTile {\n");
...
static {
  ...
  JSON.registerDiscriminator(AssignedEntitiesTile.class, "tileType", mappings);
}
}
