 ...
 */
@ApiModel(description = "Comparison for `FLAW_STATE` attributes.")
@JsonPropertyOrder({
  FlawStateComparisonInfo.JSON_PROPERTY_COMPARISON,
  FlawStateComparisonInfo.JSON_PROPERTY_VALUE,
  FlawStateComparisonInfo.JSON_PROPERTY_VALUES
})
...
public class FlawStateComparisonInfo extends ComparisonInfo {
  ...
  public FlawStateComparisonInfo comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public FlawStateComparisonInfo value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this FlawStateComparisonInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FlawStateComparisonInfo flawStateComparisonInfo = (FlawStateComparisonInfo) o;
    return Objects.equals(this.comparison, flawStateComparisonInfo.comparison) &&
        Objects.equals(this.value, flawStateComparisonInfo.value) &&
        Objects.equals(this.values, flawStateComparisonInfo.values) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class FlawStateComparisonInfo {\n");
...
static {
  ...
  JSON.registerDiscriminator(FlawStateComparisonInfo.class, "type", mappings);
}
}
