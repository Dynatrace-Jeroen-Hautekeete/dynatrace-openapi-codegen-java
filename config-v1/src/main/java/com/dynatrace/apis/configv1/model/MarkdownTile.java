 ...
 */
@ApiModel(description = "Configuration of the Markdown tile.")
@JsonPropertyOrder({
  MarkdownTile.JSON_PROPERTY_MARKDOWN
})
...
public class MarkdownTile extends Tile {
  ...
  public MarkdownTile markdown(String markdown) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The markdown-formatted content of the tile.")
  ...
  /**
   * Return true if this MarkdownTile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MarkdownTile markdownTile = (MarkdownTile) o;
    return Objects.equals(this.markdown, markdownTile.markdown) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(markdown, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MarkdownTile {\n");
...
static {
  ...
  JSON.registerDiscriminator(MarkdownTile.class, "tileType", mappings);
}
}
