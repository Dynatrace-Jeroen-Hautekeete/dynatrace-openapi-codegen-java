 ...
 */
@ApiModel(description = "Comparison for `HTTP_STATUS_CLASS` attributes.")
@JsonPropertyOrder({
  HttpStatusClassComparisonInfo.JSON_PROPERTY_COMPARISON,
  HttpStatusClassComparisonInfo.JSON_PROPERTY_VALUE,
  HttpStatusClassComparisonInfo.JSON_PROPERTY_VALUES
})
...
public class HttpStatusClassComparisonInfo extends ComparisonInfo {
  ...
  public HttpStatusClassComparisonInfo comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public HttpStatusClassComparisonInfo value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this HttpStatusClassComparisonInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    HttpStatusClassComparisonInfo httpStatusClassComparisonInfo = (HttpStatusClassComparisonInfo) o;
    return Objects.equals(this.comparison, httpStatusClassComparisonInfo.comparison) &&
        Objects.equals(this.value, httpStatusClassComparisonInfo.value) &&
        Objects.equals(this.values, httpStatusClassComparisonInfo.values) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class HttpStatusClassComparisonInfo {\n");
...
static {
  ...
  JSON.registerDiscriminator(HttpStatusClassComparisonInfo.class, "type", mappings);
}
}
