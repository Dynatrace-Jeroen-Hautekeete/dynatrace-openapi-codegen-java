 ...
 */
@ApiModel(description = "Comparison for `INDEXED_STRING` attributes.")
@JsonPropertyOrder({
  IndexedStringComparison.JSON_PROPERTY_OPERATOR,
  IndexedStringComparison.JSON_PROPERTY_VALUE
})
...
public class IndexedStringComparison extends ComparisonBasic {
  /**
  ...
  public IndexedStringComparison() { 
  }

  public IndexedStringComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public IndexedStringComparison value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this IndexedStringComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IndexedStringComparison indexedStringComparison = (IndexedStringComparison) o;
    return Objects.equals(this.operator, indexedStringComparison.operator) &&
        Objects.equals(this.value, indexedStringComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class IndexedStringComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(IndexedStringComparison.class, "type", mappings);
}
}
