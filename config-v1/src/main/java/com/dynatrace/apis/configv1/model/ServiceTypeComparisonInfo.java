...
@JsonPropertyOrder({
  ServiceTypeComparisonInfo.JSON_PROPERTY_COMPARISON,
  ServiceTypeComparisonInfo.JSON_PROPERTY_VALUE,
  ServiceTypeComparisonInfo.JSON_PROPERTY_VALUES
})
...
public class ServiceTypeComparisonInfo extends ComparisonInfo<com.dynatrace.apis.configv1.model.ServiceTypeComparisonInfo.ValueEnum> {
  /**
...
//  private Set<ValuesEnum> values = null;
  ...
  public ServiceTypeComparisonInfo() { 
  }

  public ServiceTypeComparisonInfo comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public ServiceTypeComparisonInfo value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public ServiceTypeComparisonInfo values(Set<ValueEnum> values) {
    this.values = values;
    return this;
  }

  public ServiceTypeComparisonInfo addValuesItem(ValueEnum valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this ServiceTypeComparisonInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ServiceTypeComparisonInfo serviceTypeComparisonInfo = (ServiceTypeComparisonInfo) o;
    return Objects.equals(this.comparison, serviceTypeComparisonInfo.comparison) &&
        Objects.equals(this.value, serviceTypeComparisonInfo.value) &&
        Objects.equals(this.values, serviceTypeComparisonInfo.values) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTypeComparisonInfo {\n");
...
static {
  ...
  JSON.registerDiscriminator(ServiceTypeComparisonInfo.class, "type", mappings);
}
}
