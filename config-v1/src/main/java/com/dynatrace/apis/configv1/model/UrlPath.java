 ...
 */
@ApiModel(description = "The contribution from the URL, where the web request has been detected, into service ID calculation.    You have two mutually exclusive options:  * Override the detected value with a specified static value. Specify the new value in the **valueOverride** field.  * Dynamically transform the detected value. Specify the transformation parameters in the **transformations** field.")
@JsonPropertyOrder({
  UrlPath.JSON_PROPERTY_TRANSFORMATIONS,
  UrlPath.JSON_PROPERTY_VALUE_OVERRIDE
})
...
public class UrlPath {
  ...
  public UrlPath transformations(List<TransformationBase> transformations) {
    this.transformations = transformations;
    return this;
  }

  public UrlPath addTransformationsItem(TransformationBase transformationsItem) {
  ...
  **/
  ...
  public UrlPath valueOverride(String valueOverride) {
  ...
  **/
  ...
  /**
   * Return true if this UrlPath object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transformations, urlPath.transformations) &&
        Objects.equals(this.valueOverride, urlPath.valueOverride);
  }
