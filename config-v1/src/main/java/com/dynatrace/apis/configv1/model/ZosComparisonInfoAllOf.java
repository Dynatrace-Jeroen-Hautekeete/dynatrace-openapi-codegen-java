 ...
 */
@JsonPropertyOrder({
  ZosComparisonInfoAllOf.JSON_PROPERTY_COMPARISON,
  ZosComparisonInfoAllOf.JSON_PROPERTY_VALUE,
  ZosComparisonInfoAllOf.JSON_PROPERTY_VALUES
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-02T15:07:55.784964900+01:00[Europe/Brussels]")
public class ZosComparisonInfoAllOf {
  /**
  ...
  public ZosComparisonInfoAllOf() { 
  }

  public ZosComparisonInfoAllOf comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public ZosComparisonInfoAllOf value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public ZosComparisonInfoAllOf values(Set<ValuesEnum> values) {
    this.values = values;
    return this;
  }

  public ZosComparisonInfoAllOf addValuesItem(ValuesEnum valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this ZosComparisonInfo_allOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ZosComparisonInfoAllOf zosComparisonInfoAllOf = (ZosComparisonInfoAllOf) o;
    return Objects.equals(this.comparison, zosComparisonInfoAllOf.comparison) &&
        Objects.equals(this.value, zosComparisonInfoAllOf.value) &&
        Objects.equals(this.values, zosComparisonInfoAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZosComparisonInfoAllOf {\n");
