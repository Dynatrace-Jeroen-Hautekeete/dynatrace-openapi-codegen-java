 ...
 */
@ApiModel(description = "Comparison for `DATABASE_TOPOLOGY` attributes.")
@JsonPropertyOrder({
  DatabaseTopologyComparison.JSON_PROPERTY_OPERATOR,
  DatabaseTopologyComparison.JSON_PROPERTY_VALUE
})
...
public class DatabaseTopologyComparison extends ComparisonBasic {
  /**
  ...
  public DatabaseTopologyComparison() { 
  }

  public DatabaseTopologyComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public DatabaseTopologyComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this DatabaseTopologyComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DatabaseTopologyComparison databaseTopologyComparison = (DatabaseTopologyComparison) o;
    return Objects.equals(this.operator, databaseTopologyComparison.operator) &&
        Objects.equals(this.value, databaseTopologyComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseTopologyComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(DatabaseTopologyComparison.class, "type", mappings);
}
}
