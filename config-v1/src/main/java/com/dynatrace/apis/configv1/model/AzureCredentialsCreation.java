...
@JsonPropertyOrder({
  AzureCredentialsCreation.JSON_PROPERTY_METADATA,
  AzureCredentialsCreation.JSON_PROPERTY_ID,
  AzureCredentialsCreation.JSON_PROPERTY_LABEL,
  AzureCredentialsCreation.JSON_PROPERTY_APP_ID,
  AzureCredentialsCreation.JSON_PROPERTY_DIRECTORY_ID,
  AzureCredentialsCreation.JSON_PROPERTY_KEY,
  AzureCredentialsCreation.JSON_PROPERTY_ACTIVE,
  AzureCredentialsCreation.JSON_PROPERTY_AUTO_TAGGING,
  AzureCredentialsCreation.JSON_PROPERTY_MONITOR_ONLY_TAGGED_ENTITIES,
  AzureCredentialsCreation.JSON_PROPERTY_MONITOR_ONLY_TAG_PAIRS,
  AzureCredentialsCreation.JSON_PROPERTY_MONITOR_ONLY_EXCLUDING_TAG_PAIRS,
  AzureCredentialsCreation.JSON_PROPERTY_SUPPORTING_SERVICES
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-02T15:07:55.784964900+01:00[Europe/Brussels]")
public class AzureCredentialsCreation {
  ...
  public AzureCredentialsCreation() { 
  }
  ...
  public AzureCredentialsCreation metadata(ConfigurationMetadata metadata) {
  ...
  **/
  ...
  public AzureCredentialsCreation label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public AzureCredentialsCreation appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The application ID (also referred to as client ID).   The field is **required** when creating a new credentials configuration.    The field is ignored during an update, the old value remains unaffected.")
  ...
  public AzureCredentialsCreation directoryId(String directoryId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The directory ID (also referred to as tenant ID).   The field is **required** when creating a new credentials configuration.    The field is ignored during an update, the old value remains unaffected.")
  ...
  public AzureCredentialsCreation key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The secret key associated with the application ID.   For security reasons, GET requests return this field as `null`.    Submit your key on creation or update of the configuration.    The field is **required** when creating a new credentials configuration. If the field is omitted during an update, the old value remains unaffected.")
  ...
  public AzureCredentialsCreation active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public AzureCredentialsCreation autoTagging(Boolean autoTagging) {
  ...
  **/
  ...
  public AzureCredentialsCreation monitorOnlyTaggedEntities(Boolean monitorOnlyTaggedEntities) {
  ...
  **/
  ...
  public AzureCredentialsCreation monitorOnlyTagPairs(Set<CloudTag> monitorOnlyTagPairs) {
    this.monitorOnlyTagPairs = monitorOnlyTagPairs;
    return this;
  }

  public AzureCredentialsCreation addMonitorOnlyTagPairsItem(CloudTag monitorOnlyTagPairsItem) {
  ...
  **/
  ...
  public AzureCredentialsCreation monitorOnlyExcludingTagPairs(Set<CloudTag> monitorOnlyExcludingTagPairs) {
    this.monitorOnlyExcludingTagPairs = monitorOnlyExcludingTagPairs;
    return this;
  }

  public AzureCredentialsCreation addMonitorOnlyExcludingTagPairsItem(CloudTag monitorOnlyExcludingTagPairsItem) {
  ...
  **/
  ...
  public AzureCredentialsCreation supportingServices(List<AzureSupportingService> supportingServices) {
    this.supportingServices = supportingServices;
    return this;
  }

  public AzureCredentialsCreation addSupportingServicesItem(AzureSupportingService supportingServicesItem) {
  ...
  **/
  ...
  /**
   * Return true if this AzureCredentialsCreation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AzureCredentialsCreation azureCredentialsCreation = (AzureCredentialsCreation) o;
    return Objects.equals(this.metadata, azureCredentialsCreation.metadata) &&
        Objects.equals(this.id, azureCredentialsCreation.id) &&
        Objects.equals(this.label, azureCredentialsCreation.label) &&
        Objects.equals(this.appId, azureCredentialsCreation.appId) &&
        Objects.equals(this.directoryId, azureCredentialsCreation.directoryId) &&
        Objects.equals(this.key, azureCredentialsCreation.key) &&
        Objects.equals(this.active, azureCredentialsCreation.active) &&
        Objects.equals(this.autoTagging, azureCredentialsCreation.autoTagging) &&
        Objects.equals(this.monitorOnlyTaggedEntities, azureCredentialsCreation.monitorOnlyTaggedEntities) &&
        Objects.equals(this.monitorOnlyTagPairs, azureCredentialsCreation.monitorOnlyTagPairs) &&
        Objects.equals(this.monitorOnlyExcludingTagPairs, azureCredentialsCreation.monitorOnlyExcludingTagPairs) &&
        Objects.equals(this.supportingServices, azureCredentialsCreation.supportingServices);
  }
  ...
  public String toString() {
    ...
    sb.append("class AzureCredentialsCreation {\n");
