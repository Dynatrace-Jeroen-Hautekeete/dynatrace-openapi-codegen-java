 ...
 */
@ApiModel(description = "Comparison for `APPLICATION_TYPE` attributes.")
@JsonPropertyOrder({
  ApplicationTypeComparison.JSON_PROPERTY_OPERATOR,
  ApplicationTypeComparison.JSON_PROPERTY_VALUE
})
...
public class ApplicationTypeComparison extends ComparisonBasic {
  /**
  ...
  public ApplicationTypeComparison() { 
  }

  public ApplicationTypeComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public ApplicationTypeComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this ApplicationTypeComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApplicationTypeComparison applicationTypeComparison = (ApplicationTypeComparison) o;
    return Objects.equals(this.operator, applicationTypeComparison.operator) &&
        Objects.equals(this.value, applicationTypeComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationTypeComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(ApplicationTypeComparison.class, "type", mappings);
}
}
