 ...
 */
@ApiModel(description = "Comparison for `DCRUM_DECODER_TYPE` attributes.")
@JsonPropertyOrder({
  DcrumDecoderComparison.JSON_PROPERTY_OPERATOR,
  DcrumDecoderComparison.JSON_PROPERTY_VALUE
})
...
public class DcrumDecoderComparison extends ComparisonBasic {
  /**
  ...
  public DcrumDecoderComparison() { 
  }

  public DcrumDecoderComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public DcrumDecoderComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this DcrumDecoderComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DcrumDecoderComparison dcrumDecoderComparison = (DcrumDecoderComparison) o;
    return Objects.equals(this.operator, dcrumDecoderComparison.operator) &&
        Objects.equals(this.value, dcrumDecoderComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DcrumDecoderComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(DcrumDecoderComparison.class, "type", mappings);
}
}
