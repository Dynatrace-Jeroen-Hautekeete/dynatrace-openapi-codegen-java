 ...
 */
@ApiModel(description = "Comparison for `OS_TYPE` attributes.")
@JsonPropertyOrder({
  OsTypeComparison.JSON_PROPERTY_OPERATOR,
  OsTypeComparison.JSON_PROPERTY_VALUE
})
...
public class OsTypeComparison extends ComparisonBasic {
  /**
  ...
  public OsTypeComparison() { 
  }

  public OsTypeComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public OsTypeComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this OsTypeComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OsTypeComparison osTypeComparison = (OsTypeComparison) o;
    return Objects.equals(this.operator, osTypeComparison.operator) &&
        Objects.equals(this.value, osTypeComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class OsTypeComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(OsTypeComparison.class, "type", mappings);
}
}
