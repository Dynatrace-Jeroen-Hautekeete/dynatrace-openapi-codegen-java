 ...
 */
@ApiModel(description = "Comparison for `NUMBER` attributes.")
@JsonPropertyOrder({
  NumberComparisonInfo.JSON_PROPERTY_COMPARISON,
  NumberComparisonInfo.JSON_PROPERTY_VALUE,
  NumberComparisonInfo.JSON_PROPERTY_VALUES
})
...
public class NumberComparisonInfo extends ComparisonInfo<BigDecimal> {
  /**
...
//  private Set<BigDecimal> values = null;
  ...
  public NumberComparisonInfo() { 
  }

  public NumberComparisonInfo comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public NumberComparisonInfo value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public NumberComparisonInfo values(Set<BigDecimal> values) {
    this.values = values;
    return this;
  }

  public NumberComparisonInfo addValuesItem(BigDecimal valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this NumberComparisonInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NumberComparisonInfo numberComparisonInfo = (NumberComparisonInfo) o;
    return Objects.equals(this.comparison, numberComparisonInfo.comparison) &&
        Objects.equals(this.value, numberComparisonInfo.value) &&
        Objects.equals(this.values, numberComparisonInfo.values) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class NumberComparisonInfo {\n");
...
static {
  ...
  JSON.registerDiscriminator(NumberComparisonInfo.class, "type", mappings);
}
}
