 ...
 */
@ApiModel(description = "Comparison for `CUSTOM_APPLICATION_TYPE` attributes.")
@JsonPropertyOrder({
  CustomApplicationTypeComparison.JSON_PROPERTY_OPERATOR,
  CustomApplicationTypeComparison.JSON_PROPERTY_VALUE
})
...
public class CustomApplicationTypeComparison extends ComparisonBasic {
  /**
  ...
  public CustomApplicationTypeComparison() { 
  }

  public CustomApplicationTypeComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public CustomApplicationTypeComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this CustomApplicationTypeComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CustomApplicationTypeComparison customApplicationTypeComparison = (CustomApplicationTypeComparison) o;
    return Objects.equals(this.operator, customApplicationTypeComparison.operator) &&
        Objects.equals(this.value, customApplicationTypeComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomApplicationTypeComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(CustomApplicationTypeComparison.class, "type", mappings);
}
}
