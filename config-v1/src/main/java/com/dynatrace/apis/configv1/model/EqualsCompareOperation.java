 ...
 */
@ApiModel(description = "The condition of the `EQUALS` type.   The condition checks whether the detected value equals the specified one.")
@JsonPropertyOrder({
  EqualsCompareOperation.JSON_PROPERTY_NEGATE,
  EqualsCompareOperation.JSON_PROPERTY_IGNORE_CASE,
  EqualsCompareOperation.JSON_PROPERTY_VALUES
})
...
public class EqualsCompareOperation extends CompareOperation {
  ...
  public EqualsCompareOperation() { 
  }

  public EqualsCompareOperation negate(Boolean negate) {
    this.negate = negate;
    return this;
  }
  ...
  **/
  ...
  public EqualsCompareOperation ignoreCase(Boolean ignoreCase) {
  ...
  **/
  ...
  public EqualsCompareOperation values(Set<Object> values) {
    this.values = values;
    return this;
  }

  public EqualsCompareOperation addValuesItem(Object valuesItem) {
  ...
  **/
  ...
  /**
   * Return true if this EqualsCompareOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EqualsCompareOperation equalsCompareOperation = (EqualsCompareOperation) o;
    return Objects.equals(this.negate, equalsCompareOperation.negate) &&
        Objects.equals(this.ignoreCase, equalsCompareOperation.ignoreCase) &&
        Objects.equals(this.values, equalsCompareOperation.values) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EqualsCompareOperation {\n");
...
static {
  ...
  JSON.registerDiscriminator(EqualsCompareOperation.class, "type", mappings);
}
}
