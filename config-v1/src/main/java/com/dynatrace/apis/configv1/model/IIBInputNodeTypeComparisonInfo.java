 ...
 */
@ApiModel(description = "Comparison for `IIB_INPUT_NODE_TYPE` attributes.")
@JsonPropertyOrder({
  IIBInputNodeTypeComparisonInfo.JSON_PROPERTY_COMPARISON,
  IIBInputNodeTypeComparisonInfo.JSON_PROPERTY_VALUE,
  IIBInputNodeTypeComparisonInfo.JSON_PROPERTY_VALUES
})
...
public class IIBInputNodeTypeComparisonInfo extends ComparisonInfo<com.dynatrace.apis.configv1.model.IIBInputNodeTypeComparisonInfo.ValueEnum> {
  /**
...
//  private Set<ValuesEnum> values = null;
  ...
  public IIBInputNodeTypeComparisonInfo() { 
  }

  public IIBInputNodeTypeComparisonInfo comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public IIBInputNodeTypeComparisonInfo value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public IIBInputNodeTypeComparisonInfo values(Set<ValueEnum> values) {
    this.values = values;
    return this;
  }

  public IIBInputNodeTypeComparisonInfo addValuesItem(ValueEnum valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this IIBInputNodeTypeComparisonInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IIBInputNodeTypeComparisonInfo iiBInputNodeTypeComparisonInfo = (IIBInputNodeTypeComparisonInfo) o;
    return Objects.equals(this.comparison, iiBInputNodeTypeComparisonInfo.comparison) &&
        Objects.equals(this.value, iiBInputNodeTypeComparisonInfo.value) &&
        Objects.equals(this.values, iiBInputNodeTypeComparisonInfo.values) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class IIBInputNodeTypeComparisonInfo {\n");
...
static {
  ...
  JSON.registerDiscriminator(IIBInputNodeTypeComparisonInfo.class, "type", mappings);
}
}
