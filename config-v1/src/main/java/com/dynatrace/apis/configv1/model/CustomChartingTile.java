 ...
 */
@ApiModel(description = "Configuration of a custom chart tile.")
@JsonPropertyOrder({
  CustomChartingTile.JSON_PROPERTY_FILTER_CONFIG
})
...
public class CustomChartingTile extends Tile {
  public static final String JSON_PROPERTY_FILTER_CONFIG = "filterConfig";
  private CustomFilterConfig filterConfig;

  public CustomChartingTile() { 
  }

  public CustomChartingTile filterConfig(CustomFilterConfig filterConfig) {
  ...
  **/
  ...
  /**
   * Return true if this CustomChartingTile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CustomChartingTile customChartingTile = (CustomChartingTile) o;
    return Objects.equals(this.filterConfig, customChartingTile.filterConfig) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filterConfig, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomChartingTile {\n");
...
static {
  ...
  JSON.registerDiscriminator(CustomChartingTile.class, "tileType", mappings);
}
}
