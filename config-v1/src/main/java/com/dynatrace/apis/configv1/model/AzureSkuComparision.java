 ...
 */
@ApiModel(description = "Comparison for `AZURE_SKU` attributes.")
@JsonPropertyOrder({
  AzureSkuComparision.JSON_PROPERTY_OPERATOR,
  AzureSkuComparision.JSON_PROPERTY_VALUE
})
...
public class AzureSkuComparision extends ComparisonBasic {
  /**
  ...
  public AzureSkuComparision() { 
  }

  public AzureSkuComparision operator(OperatorEnum operator) {
  ...
  **/
  ...
  public AzureSkuComparision value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this AzureSkuComparision object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AzureSkuComparision azureSkuComparision = (AzureSkuComparision) o;
    return Objects.equals(this.operator, azureSkuComparision.operator) &&
        Objects.equals(this.value, azureSkuComparision.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AzureSkuComparision {\n");
...
static {
  ...
  JSON.registerDiscriminator(AzureSkuComparision.class, "type", mappings);
}
}
