 ...
 */
@JsonPropertyOrder({
  EmailNotificationConfigAllOf.JSON_PROPERTY_SUBJECT,
  EmailNotificationConfigAllOf.JSON_PROPERTY_BODY,
  EmailNotificationConfigAllOf.JSON_PROPERTY_RECEIVERS,
  EmailNotificationConfigAllOf.JSON_PROPERTY_CC_RECEIVERS,
  EmailNotificationConfigAllOf.JSON_PROPERTY_BCC_RECEIVERS
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-02T15:07:55.784964900+01:00[Europe/Brussels]")
public class EmailNotificationConfigAllOf {
  ...
  public EmailNotificationConfigAllOf() { 
  }

  public EmailNotificationConfigAllOf subject(String subject) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The subject of the email notifications.")
  ...
  public EmailNotificationConfigAllOf body(String body) {
    this.body = body;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The template of the email notification.   You can use the following placeholders:  * `{ImpactedEntities}`: Details about the entities impacted by the problem in form of a JSON array.  * `{ImpactedEntity}`: The entity impacted by the problem or *X* impacted entities.  * `{PID}`: The ID of the reported problem.  * `{ProblemDetailsHTML}`: All problem event details, including root cause, as an HTML-formatted string.  * `{ProblemDetailsJSON}`: All problem event details, including root cause, as a JSON object.  * `{ProblemDetailsMarkdown}`: All problem event details, including root cause, as a [Markdown-formatted](https://dt-url.net/1yk3kkq) string.  * `{ProblemDetailsText}`: All problem event details, including root cause, as a text-formatted string.  * `{ProblemID}`: The display number of the reported problem.  * `{ProblemImpact}`: The [impact level](https://dt-url.net/klg3k4q) of the problem. Possible values are `APPLICATION`, `SERVICE`, and `INFRASTRUCTURE`.  * `{ProblemSeverity}`: The [severity level](https://dt-url.net/f1i3k5b) of the problem. Possible values are `AVAILABILITY`, `ERROR`, `PERFORMANCE`, `RESOURCE_CONTENTION`, and `CUSTOM_ALERT`.  * `{ProblemTitle}`: A short description of the problem.  * `{ProblemURL}`: The URL of the problem within Dynatrace.  * `{State}`: The state of the problem. Possible values are `OPEN` and `RESOLVED`.  * `{Tags}`: The list of tags that are defined for all impacted entities, separated by commas.  ")
  ...
  public EmailNotificationConfigAllOf receivers(Set<String> receivers) {
    this.receivers = receivers;
    return this;
  }

  public EmailNotificationConfigAllOf addReceiversItem(String receiversItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The list of the email recipients.")
  ...
  public EmailNotificationConfigAllOf ccReceivers(Set<String> ccReceivers) {
    this.ccReceivers = ccReceivers;
    return this;
  }

  public EmailNotificationConfigAllOf addCcReceiversItem(String ccReceiversItem) {
  ...
  **/
  ...
  public EmailNotificationConfigAllOf bccReceivers(Set<String> bccReceivers) {
    this.bccReceivers = bccReceivers;
    return this;
  }

  public EmailNotificationConfigAllOf addBccReceiversItem(String bccReceiversItem) {
  ...
  **/
  ...
  /**
   * Return true if this EmailNotificationConfig_allOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EmailNotificationConfigAllOf emailNotificationConfigAllOf = (EmailNotificationConfigAllOf) o;
    return Objects.equals(this.subject, emailNotificationConfigAllOf.subject) &&
        Objects.equals(this.body, emailNotificationConfigAllOf.body) &&
        Objects.equals(this.receivers, emailNotificationConfigAllOf.receivers) &&
        Objects.equals(this.ccReceivers, emailNotificationConfigAllOf.ccReceivers) &&
        Objects.equals(this.bccReceivers, emailNotificationConfigAllOf.bccReceivers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subject, body, receivers, ccReceivers, bccReceivers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailNotificationConfigAllOf {\n");
