 ...
 */
@ApiModel(description = "Comparison for `CLOUD_TYPE` attributes.")
@JsonPropertyOrder({
  CloudTypeComparison.JSON_PROPERTY_OPERATOR,
  CloudTypeComparison.JSON_PROPERTY_VALUE
})
...
public class CloudTypeComparison extends ComparisonBasic {
  /**
  ...
  public CloudTypeComparison() { 
  }

  public CloudTypeComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public CloudTypeComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this CloudTypeComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CloudTypeComparison cloudTypeComparison = (CloudTypeComparison) o;
    return Objects.equals(this.operator, cloudTypeComparison.operator) &&
        Objects.equals(this.value, cloudTypeComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudTypeComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(CloudTypeComparison.class, "type", mappings);
}
}
