 ...
 */
@JsonPropertyOrder({
  AssignedEntitiesTileAllOf.JSON_PROPERTY_ASSIGNED_ENTITIES
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-02T15:07:55.784964900+01:00[Europe/Brussels]")
public class AssignedEntitiesTileAllOf {
  public static final String JSON_PROPERTY_ASSIGNED_ENTITIES = "assignedEntities";
  private List<String> assignedEntities = null;

  public AssignedEntitiesTileAllOf() { 
  }

  public AssignedEntitiesTileAllOf assignedEntities(List<String> assignedEntities) {
    this.assignedEntities = assignedEntities;
    return this;
  }

  public AssignedEntitiesTileAllOf addAssignedEntitiesItem(String assignedEntitiesItem) {
  ...
  **/
  ...
  /**
   * Return true if this AssignedEntitiesTile_allOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AssignedEntitiesTileAllOf assignedEntitiesTileAllOf = (AssignedEntitiesTileAllOf) o;
    return Objects.equals(this.assignedEntities, assignedEntitiesTileAllOf.assignedEntities);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assignedEntities);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssignedEntitiesTileAllOf {\n");
