 ...
 */
@JsonPropertyOrder({
  BooleanComparisonInfoAllOf.JSON_PROPERTY_COMPARISON,
  BooleanComparisonInfoAllOf.JSON_PROPERTY_VALUE,
  BooleanComparisonInfoAllOf.JSON_PROPERTY_VALUES
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-02T15:07:55.784964900+01:00[Europe/Brussels]")
public class BooleanComparisonInfoAllOf {
  /**
  ...
  public BooleanComparisonInfoAllOf() { 
  }

  public BooleanComparisonInfoAllOf comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public BooleanComparisonInfoAllOf value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public BooleanComparisonInfoAllOf values(Set<Boolean> values) {
    this.values = values;
    return this;
  }

  public BooleanComparisonInfoAllOf addValuesItem(Boolean valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this BooleanComparisonInfo_allOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BooleanComparisonInfoAllOf booleanComparisonInfoAllOf = (BooleanComparisonInfoAllOf) o;
    return Objects.equals(this.comparison, booleanComparisonInfoAllOf.comparison) &&
        Objects.equals(this.value, booleanComparisonInfoAllOf.value) &&
        Objects.equals(this.values, booleanComparisonInfoAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class BooleanComparisonInfoAllOf {\n");
