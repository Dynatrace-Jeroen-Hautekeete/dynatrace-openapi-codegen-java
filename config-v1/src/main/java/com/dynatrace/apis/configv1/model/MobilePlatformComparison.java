 ...
 */
@ApiModel(description = "Comparison for `MOBILE_PLATFORM` attributes.")
@JsonPropertyOrder({
  MobilePlatformComparison.JSON_PROPERTY_OPERATOR,
  MobilePlatformComparison.JSON_PROPERTY_VALUE
})
...
public class MobilePlatformComparison extends ComparisonBasic {
  /**
  ...
  public MobilePlatformComparison() { 
  }

  public MobilePlatformComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public MobilePlatformComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this MobilePlatformComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MobilePlatformComparison mobilePlatformComparison = (MobilePlatformComparison) o;
    return Objects.equals(this.operator, mobilePlatformComparison.operator) &&
        Objects.equals(this.value, mobilePlatformComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class MobilePlatformComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(MobilePlatformComparison.class, "type", mappings);
}
}
