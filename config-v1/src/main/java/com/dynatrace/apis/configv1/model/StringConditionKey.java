 ...
 */
@ApiModel(description = "The key for dynamic attributes of the `STRING` type.")
@JsonPropertyOrder({
  StringConditionKey.JSON_PROPERTY_DYNAMIC_KEY
})
...
public class StringConditionKey extends ConditionKey {
  public static final String JSON_PROPERTY_DYNAMIC_KEY = "dynamicKey";
  private String dynamicKey;

  public StringConditionKey() { 
  }

  public StringConditionKey dynamicKey(String dynamicKey) {
  ...
  **/
  ...
  /**
   * Return true if this StringConditionKey object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StringConditionKey stringConditionKey = (StringConditionKey) o;
    return Objects.equals(this.dynamicKey, stringConditionKey.dynamicKey) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class StringConditionKey {\n");
...
static {
  ...
  JSON.registerDiscriminator(StringConditionKey.class, "type", mappings);
}
}
