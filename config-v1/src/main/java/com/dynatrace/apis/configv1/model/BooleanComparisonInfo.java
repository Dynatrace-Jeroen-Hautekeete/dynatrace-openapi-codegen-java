 ...
 */
@ApiModel(description = "Comparison for `BOOLEAN` attributes.")
@JsonPropertyOrder({
  BooleanComparisonInfo.JSON_PROPERTY_COMPARISON,
  BooleanComparisonInfo.JSON_PROPERTY_VALUE,
  BooleanComparisonInfo.JSON_PROPERTY_VALUES
})
...
//  private Set<Boolean> values = null;
  ...
  public BooleanComparisonInfo comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public BooleanComparisonInfo value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public BooleanComparisonInfo values(Set<Boolean> values) {
    this.values = values;
    return this;
  }

  public BooleanComparisonInfo addValuesItem(Boolean valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this BooleanComparisonInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BooleanComparisonInfo booleanComparisonInfo = (BooleanComparisonInfo) o;
    return Objects.equals(this.comparison, booleanComparisonInfo.comparison) &&
        Objects.equals(this.value, booleanComparisonInfo.value) &&
        Objects.equals(this.values, booleanComparisonInfo.values) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class BooleanComparisonInfo {\n");
...
static {
  ...
  JSON.registerDiscriminator(BooleanComparisonInfo.class, "type", mappings);
}
}
