 ...
 */
@ApiModel(description = "Comparison for `AZURE_COMPUTE_MODE` attributes.")
@JsonPropertyOrder({
  AzureComputeModeComparison.JSON_PROPERTY_OPERATOR,
  AzureComputeModeComparison.JSON_PROPERTY_VALUE
})
...
public class AzureComputeModeComparison extends ComparisonBasic {
  /**
  ...
  public AzureComputeModeComparison() { 
  }

  public AzureComputeModeComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public AzureComputeModeComparison value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this AzureComputeModeComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AzureComputeModeComparison azureComputeModeComparison = (AzureComputeModeComparison) o;
    return Objects.equals(this.operator, azureComputeModeComparison.operator) &&
        Objects.equals(this.value, azureComputeModeComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AzureComputeModeComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(AzureComputeModeComparison.class, "type", mappings);
}
}
