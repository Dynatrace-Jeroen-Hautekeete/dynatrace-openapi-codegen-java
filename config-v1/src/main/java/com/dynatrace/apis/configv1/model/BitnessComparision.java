 ...
 */
@ApiModel(description = "Comparison for `BITNESS` attributes.")
@JsonPropertyOrder({
  BitnessComparision.JSON_PROPERTY_OPERATOR,
  BitnessComparision.JSON_PROPERTY_VALUE
})
...
public class BitnessComparision extends ComparisonBasic {
  /**
  ...
  public BitnessComparision() { 
  }

  public BitnessComparision operator(OperatorEnum operator) {
  ...
  **/
  ...
  public BitnessComparision value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this BitnessComparision object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BitnessComparision bitnessComparision = (BitnessComparision) o;
    return Objects.equals(this.operator, bitnessComparision.operator) &&
        Objects.equals(this.value, bitnessComparision.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class BitnessComparision {\n");
...
static {
  ...
  JSON.registerDiscriminator(BitnessComparision.class, "type", mappings);
}
}
