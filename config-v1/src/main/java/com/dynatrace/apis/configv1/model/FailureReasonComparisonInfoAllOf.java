 ...
 */
@JsonPropertyOrder({
  FailureReasonComparisonInfoAllOf.JSON_PROPERTY_COMPARISON,
  FailureReasonComparisonInfoAllOf.JSON_PROPERTY_VALUE,
  FailureReasonComparisonInfoAllOf.JSON_PROPERTY_VALUES
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-02T15:07:55.784964900+01:00[Europe/Brussels]")
public class FailureReasonComparisonInfoAllOf {
  /**
  ...
  public FailureReasonComparisonInfoAllOf() { 
  }

  public FailureReasonComparisonInfoAllOf comparison(ComparisonEnum comparison) {
  ...
  **/
  ...
  public FailureReasonComparisonInfoAllOf value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public FailureReasonComparisonInfoAllOf values(Set<ValuesEnum> values) {
    this.values = values;
    return this;
  }

  public FailureReasonComparisonInfoAllOf addValuesItem(ValuesEnum valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this FailureReasonComparisonInfo_allOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FailureReasonComparisonInfoAllOf failureReasonComparisonInfoAllOf = (FailureReasonComparisonInfoAllOf) o;
    return Objects.equals(this.comparison, failureReasonComparisonInfoAllOf.comparison) &&
        Objects.equals(this.value, failureReasonComparisonInfoAllOf.value) &&
        Objects.equals(this.values, failureReasonComparisonInfoAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class FailureReasonComparisonInfoAllOf {\n");
