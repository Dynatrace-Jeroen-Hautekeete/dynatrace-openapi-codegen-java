...
@JsonPropertyOrder({
  PublicDomainName.JSON_PROPERTY_TRANSFORMATIONS,
  PublicDomainName.JSON_PROPERTY_VALUE_OVERRIDE,
  PublicDomainName.JSON_PROPERTY_COPY_FROM_HOST_NAME
})
...
public class PublicDomainName {
  ...
  public static final String JSON_PROPERTY_COPY_FROM_HOST_NAME = "copyFromHostName";
  private Boolean copyFromHostName;

  public PublicDomainName() { 
  }

  public PublicDomainName transformations(List<TransformationBase> transformations) {
    this.transformations = transformations;
    return this;
  }

  public PublicDomainName addTransformationsItem(TransformationBase transformationsItem) {
  ...
  **/
  ...
  public PublicDomainName valueOverride(String valueOverride) {
  ...
  **/
  ...
  public PublicDomainName copyFromHostName(Boolean copyFromHostName) {
   ...
   * @return copyFromHostName
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use (`true`) or don't use (`false`) the detected host name as base for transformation.    Not applicable if the override is specified.")
  @JsonProperty(JSON_PROPERTY_COPY_FROM_HOST_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getCopyFromHostName() {
    return copyFromHostName;
  }
  ...
  @JsonProperty(JSON_PROPERTY_COPY_FROM_HOST_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCopyFromHostName(Boolean copyFromHostName) {
    this.copyFromHostName = copyFromHostName;
  }


  /**
   * Return true if this PublicDomainName object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicDomainName publicDomainName = (PublicDomainName) o;
    return Objects.equals(this.transformations, publicDomainName.transformations) &&
        Objects.equals(this.valueOverride, publicDomainName.valueOverride) &&
        Objects.equals(this.copyFromHostName, publicDomainName.copyFromHostName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transformations, valueOverride, copyFromHostName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicDomainName {\n");
    ...
    sb.append("    copyFromHostName: ").append(toIndentedString(copyFromHostName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
