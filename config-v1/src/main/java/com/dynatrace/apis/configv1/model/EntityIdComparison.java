 ...
 */
@ApiModel(description = "Comparison for `ENTITY_ID` attributes.")
@JsonPropertyOrder({
  EntityIdComparison.JSON_PROPERTY_OPERATOR,
  EntityIdComparison.JSON_PROPERTY_VALUE
})
...
public class EntityIdComparison extends ComparisonBasic {
  /**
  ...
  public EntityIdComparison() { 
  }

  public EntityIdComparison operator(OperatorEnum operator) {
  ...
  **/
  ...
  public EntityIdComparison value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this EntityIdComparison object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EntityIdComparison entityIdComparison = (EntityIdComparison) o;
    return Objects.equals(this.operator, entityIdComparison.operator) &&
        Objects.equals(this.value, entityIdComparison.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityIdComparison {\n");
...
static {
  ...
  JSON.registerDiscriminator(EntityIdComparison.class, "type", mappings);
}
}
